...
{
	shared_ptr<CVIBuffer_Rect> pInstance(new CVIBuffer_Rect(pDevice, pContext), [](CVIBuffer_Rect* p) {p->Free(); delete p;});
...
{
	shared_ptr<CVIBuffer_Rect> pInstance ( new CVIBuffer_Rect(*this), [](CVIBuffer_Rect* p) {p->Free(); delete p;});
